...
//    private boolean ignoreRuntimeExceptions;
     ...
     * @param maxSentenceLength limit length of sentences that parser will attempt to process to control time taken
     * @param throwExceptionOnSentenceLengthCheck if 'true', gives up on an entire input text if any sentence is too long
     */
    public StanfordDepHandler(POSTaggerAnnotator posAnnotator, ParserAnnotator parseAnnotator, int maxSentenceLength,
        ...
        super("Stanford Dependency Parser", "3.3.1", "stanforddep", ViewNames.DEPENDENCY_STANFORD,
                new String[]{}, false); // NO LAZY INITIALIZATION
