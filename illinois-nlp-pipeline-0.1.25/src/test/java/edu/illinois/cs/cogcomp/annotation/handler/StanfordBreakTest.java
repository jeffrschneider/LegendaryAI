...
public class StanfordBreakTest {
    ...
    private static StanfordDepHandler depParser;

    @BeforeClass
    public static void setUpOnce() throws IOException, AnnotatorException {
    ...
    private static List<String[]> getTokenisedText(String rawtext) {
