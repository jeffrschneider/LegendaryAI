...
public class SimpleCachingPipelineTest
{
    ...
    public static void init() throws IOException, AnnotatorException {
        ...
        processor = new SimpleCachingPipeline( new PipelineConfigurator().getConfig(new ResourceManager( props )) );
    }
    ...
    public void testTokenizedInputToPipeline()
    {
        ...
        try {
            processor.addViewsAndCache( ta, activeViews, true );
        } catch (AnnotatorException e) {
            e.printStackTrace();
            fail( e.getMessage() );
        }
    ...
    public void testSimpleCachingPipeline()
    {
        ...
        try {
            fileName = SimpleCachingPipeline.getSavePath(processor.pathToSaveCachedFiles, text);
        } catch (Exception e) {
            e.printStackTrace();
            fail(e.getMessage());
        }
